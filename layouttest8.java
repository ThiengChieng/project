...
public class layouttest8{
	...
	private static JRadioButton radiobtn2 = new JRadioButton("子群探勘");
	private static JRadioButton radiobtn3 = new JRadioButton("以原始資料為主");
	private static JRadioButton radiobtn4 = new JRadioButton("隨機森林");
	private static JRadioButton radiobtn5 = new JRadioButton("子群組探勘統計方法分析");
	private static GridBagConstraints c;
	private static File oporfile1,oporfile2;
	private RadioButtonListener radioButtonListener = new RadioButtonListener();
	public static String SRadioB="卡方檢驗";
	public static String SRadioB2="隨機森林";
	...
	public layouttest8(){
		...
		radiobtn3.setPreferredSize(new Dimension(400,120));
		radiobtn3.addActionListener(radioButtonListener);
		radiobtn4.setFont(font);
		radiobtn4.setForeground(Color.white);
		radiobtn4.setPreferredSize(new Dimension(300,120));
		radiobtn4.addActionListener(radioButtonListener);
		radiobtn5.setFont(font);
		radiobtn5.setForeground(Color.white);
		radiobtn5.setPreferredSize(new Dimension(400,120));
		radiobtn5.addActionListener(radioButtonListener);
		...
		c.gridwidth = 1; 
		c.fill = GridBagConstraints.BOTH;
		panel.add(Box.createRigidArea(new Dimension(350, 100)),c);
		...
		c.gridwidth = 1; 
		c.fill = GridBagConstraints.BOTH;
		panel.add(Box.createRigidArea(new Dimension(100, 100)),c);
		...
		c.gridwidth = 1; 
		c.fill = GridBagConstraints.BOTH;
		panel.add(Box.createRigidArea(new Dimension(200, 100)),c);
	...
	public class RadioButtonListener implements ActionListener{
        ...
        public void actionPerformed(ActionEvent arg0) {
            ...
            if(temp.isSelected() && (temp==radiobtn0 || temp==radiobtn1||temp==radiobtn2||temp==radiobtn3 )){
				if(temp.getText()=="子群探勘"){
					radiobtn5.setSelected(true);
					SRadioB2="子群組探勘統計方法分析";
				}else if(temp.getText()=="卡方檢驗"||temp.getText()=="方差過濾"||temp.getText()=="以原始資料為主"){
					radiobtn4.setSelected(true);
					SRadioB2="隨機森林";
				}else{
					System.out.println("為選擇特徵");
				}
				
		
                //System.out.println(temp.getText());
				SRadioB=temp.getText();	
            }else if(temp.isSelected() && (temp==radiobtn4||temp==radiobtn5)){
