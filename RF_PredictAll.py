...
#url3='D:/notepad++/JAVA_program/new/forall/Hos_Data/Doc_Train/Cluster/2019/'
...
# print(year)
# print(docnumber)
        ordatapath = dataurl[0:dataurl.rfind(
            "Feature")]+"Wa_Ch\\"+year+"\\"+docnumber+".csv"
...
# 設定有100個決策樹，並設置隨機數種子碼=42
        Ain=np.loadtxt(url3+filepath[0:filepath.rfind('_FT')]+'_Cluster.csv')
        print(Ain)
