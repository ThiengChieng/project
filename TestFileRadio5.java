...
public class TestFileRadio5 {
   ...
   private static String JUD_FILE[] = {"Cut","Wa_Ch","Mod_Re","Pic"};
   private static int judfile=-1;
   public static int click=0;
   
   public TestFileRadio5(int jud){ 
		click=0;
		x=0;
		judfile=-1;
		SRadioB="";
		...
		File directoryPath = new File("Hos_Data/Doc_Test/"+JUD_FILE[jud]);
   ...
   public class RadioButtonListener implements ActionListener
    {
        ...
        public void actionPerformed(ActionEvent arg0) {
			...
			File file2 = new File("Hos_Data/Doc_Test/"+JUD_FILE[judfile]+"/"+SRadioB+File.separator);
			...
			if(C2[0]=="0"){
				...
				for(int i = 0;i<x2;i++){
					...
					C2[i]=C2[i].replace("Hos_Data\\Doc_Test\\"+JUD_FILE[judfile]+"\\"+SRadioB+"\\", "");
					...
					jRadioButton2[i].addActionListener(new ActionListener() {
						...
						public void actionPerformed(ActionEvent e) {
							...
							if(temp2.isSelected()){
								OnlyName="";
								//System.out.println("Hos_Data/Doc_Test/"+JUD_FILE[judfile]+"/"+SRadioB+"/"+temp2.getText());
								SRadioB2=("Hos_Data\\Doc_Test\\"+JUD_FILE[judfile]+"\\"+SRadioB+"\\"+temp2.getText());
		...
		S2[0]="0";
			for (int i = 0; i < lists2.length; i++) {
				...
				if(lists2[i].getPath().endsWith(".csv")){
					...
					name[x2] = lists2[i].getPath().replace("Hos_Data\\Doc_Test\\"+JUD_FILE[judfile]+"\\"+SRadioB+"\\", "");
					S2[x2]=name[x2];
